...
<body>
	...
	<div class="content">
	    ...
	    <div class="left-section">
	        ...
	        <img src="data:image/jpeg;base64,<%= Base64.getEncoder().encodeToString(restaurant.getRestaurantImage()) %>" alt="">
	        <div class="favorites-box">
	            <h3>Frequently Ordered <span><%= menu.getItemName() %></span></h3>
	            <p>From <span><%= restaurant.getRestaurantName() %></span></p>
	        </div>
	        </div>
	        
	        <h3>Total Spent : &#8377;<%= session.getAttribute("total") %></h3>
    	</div>
	    ...
	    <div class="right-section">
	        ...
	        <div class="ordersCard">
	            <p>Order From: <%= restaurantDao.get(order.getRestaurantId()).getRestaurantName() %></p>
